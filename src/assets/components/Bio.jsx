...
const SkillBar = ({ label, percentage, colorClass, barColor }) => (
  <div className="mb-6">
    <div className="flex justify-between mb-2 items-end">
      <span className={`font-semibold tracking-wide text-[11px] uppercase ${colorClass}`}>
        {label}
      </span>
...
function MyBioComponent() {
  ...
  const skills = [
    { label: "HTML5", percentage: 95, colorClass: "text-orange-500", barColor: "bg-orange-500" },
    { label: "CSS3", percentage: 90, colorClass: "text-blue-500", barColor: "bg-blue-500" },
    { label: "JavaScript", percentage: 85, colorClass: "text-yellow-500", barColor: "bg-yellow-500" },
    { label: "Tailwind CSS", percentage: 88, colorClass: "text-cyan-500", barColor: "bg-cyan-500" },
    { label: "React Js", percentage: 75, colorClass: "text-sky-400", barColor: "bg-sky-400" },
    { label: "UI Design", percentage: 70, colorClass: "text-purple-500", barColor: "bg-purple-500" },
  ];

  return (
    <section id="about" className="min-h-screen bg-[#020617] flex items-center justify-center p-6 md:p-12">
      <div className="max-w-6xl w-full bg-[#0f172a]/40 backdrop-blur-md border border-slate-800/50 shadow-2xl rounded-[2rem] flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-7/12 p-8 lg:p-16 flex flex-col justify-center">
          ...
          <div className="text-slate-400 mb-8 text-base leading-relaxed">
            <p className="mb-4">
              I’m a <span className="text-white font-medium">Frontend Developer</span> dedicated to 
              crafting high-performance digital experiences. I bridge the gap between complex 
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${readMore ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
              <p className="pb-4">
                ...
                a company operating in both tech and non-tech sectors. I focus on innovation, 
                problem-solving, and creating solutions that connect technology with real-world needs.
              </p>
            </div>
